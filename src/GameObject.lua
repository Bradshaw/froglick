...
GameObject.TYPE_ZETHER = 2
GameObject.TYPE_ENEMY = 3
GameObject.TYPE_SPACEMAN = 4
GameObject.TYPE_SPLOSION = 5
GameObject.TYPE_SPACEMAN_PROJECTILE = 6
GameObject.TYPE_ENEMY_PROJECTILE = 7
